...
export function CollageCard({ entry, onClick }: CollageCardProps) {
  return (
    <button
      ...
      className="block w-[128.449px] h-[133.857px] md:w-[343.355px] md:h-[357.812px] cursor-pointer bg-[rgba(255,251,153,0.2)] shadow-[1px_2px_0.795px_0px_rgba(55,55,55,0.3)] md:shadow-[2.673px_5.346px_2.126px_0px_rgba(55,55,55,0.3)] overflow-clip transition-transform duration-200 hover:scale-105 hover:z-10"
    >
